...
var ReserveCtrlModule = require('../../../app/js/controller/reserve.js');

describe('The ReserveCtrl\'s', function() {
  ...
  beforeEach(function() {
    ...
    ReserveCtrlModule($scope, DataService);
  });

  describe('reserve process', function() {
